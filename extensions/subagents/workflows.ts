...
export function buildWorkflowPrompt(kind: WorkflowKind, task: string): string {
	return kind === "review" ? reviewPrompt(task) : chainPrompt(kind, task);
}
